...
"""
Código encontrado en: https://www.printables.com/model/818975-compact-robot-arm-arduino-3d-printed/files.

Descripción del Script: Este script se encarga del control de un brazo robótico utilizando servomotores y un controlador PWM PCA9685 conectado a una placa Jetson. 
El brazo cuenta con varios servos para mover las articulaciones (hombro, codo, muñeca, base y garra) y sensores de posición (potenciómetros) que permiten ajustar su movimiento en tiempo real. 
Asimismo, dispone de un botón para abrir y cerrar la garra.
